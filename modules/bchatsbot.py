...
def bchats_messages_menu():
    ...
    # Check if the bot id matches with @BChatsBot
    if data.get("id") != 5266916524:
    ...
    for message in data.get("messages", []):
        if message.get("from_id") == "user5266916524" and "inline_bot_buttons" in message:
    ...
    if messages:
        ...
        chat_id = base64decoder(button_data[selected_message], 1).split('-')[1].split('+')[0]
...
def bchats():
    print("Tutorial: ")
    print("  1. Export chat history of @BChatsBot")
