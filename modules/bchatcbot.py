...
def bchatc_messages_menu():
    ...
    for message in data.get("messages", []):
        if message.get("from_id") == "user5414771497" and "inline_bot_buttons" in message:
    ...
    if messages:
        ...
        chat_id = base64decoder(button_data[selected_message], 1).split("-")[1]
        message_id = base64decoder(button_data[selected_message], 1).split("-")[2]
