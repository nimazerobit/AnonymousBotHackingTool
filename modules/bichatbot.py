...
def bichat_messages_menu():
    ...
    # Check if the bot id matches with @BiChatBot
    if data.get("id") != 417529910:
    ...
    for message in data.get("messages", []):
        if message.get("from_id") == "user417529910" and "inline_bot_buttons" in message:
...
def bichat():
    print("Tutorial: ")
    print("  1. Export chat history of @BiChatBot")
